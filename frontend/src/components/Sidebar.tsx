...
type IconKind = "dashboard" | "chart" | "alerts" | "reorder" | "compare" | "data" | "inspector" | "seasonal" | "settings" | "logout";
...
const NAV: NavItem[] = [
  ...
  { key: "seasonal",  label: "Seasonal Outlook", icon: "seasonal",  description: "12-month + festivals" },
  { key: "alerts",    label: "Alerts",           icon: "alerts",    description: "Reorder + stockout risk" },
  { key: "reorder",   label: "Reorder",          icon: "reorder",   description: "Build a purchase order" },
  ...
  { key: "settings",  label: "Settings",         icon: "settings",  description: "Festivals + config" },
];
    ...
    <span className="sidebar-icon" aria-hidden>
      ...
      {kind === "settings" && (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 11-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 110-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06a1.65 1.65 0 001.82.33h0A1.65 1.65 0 009 4.6V4.5A1.5 1.5 0 0110.5 3h3A1.5 1.5 0 0115 4.5V4.6a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06A1.65 1.65 0 0019.4 9V9a1.65 1.65 0 001.51 1H21a2 2 0 110 4h-.09a1.65 1.65 0 00-1.51 1z" />
        </svg>
      )}
      {kind === "logout" && (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
